...
const _get__login__token = require(base_path + '/handlers/GET/api/login/token/get__login__token');
// let _put__login__refreshtoken = require(base_path + '/handlers/PUT/api/login/refreshtoken/put__login__refreshtoken');

const _get__profile = require(base_path + '/handlers/GET/api/profile/{user_id}/get__profile__{user_id}');
const _put__profile = require(base_path + '/handlers/PUT/api/profile/{user_id}/put__profile__{user_id}');

const _get__users = require(base_path + '/handlers/GET/api/users/get__users');
const _post__users = require(base_path + '/handlers/POST/api/users/post__users');

const _get__users__min = require(base_path + '/handlers/GET/api/users/min/get__users__min');

const _get__users__user_id = require(base_path + '/handlers/GET/api/users/{user_id}/get__users__{user_id}');
const _put__users__user_id = require(base_path + '/handlers/PUT/api/users/{user_id}/put__users__{user_id}');
const _delete__users__user_id = require(base_path + '/handlers/DELETE/api/users/{user_id}/delete__users__{user_id}');
const _patch__users__user_id__disable = require(base_path +
  '/handlers/PATCH/api/users/{user_id}/disable/patch__users__{user_id}__disable');
const _patch__users__user_id__enable = require(base_path +
  '/handlers/PATCH/api/users/{user_id}/enable/patch__users__{user_id}__enable');

const _get__quotations = require(base_path + '/handlers/GET/api/quotations/get__quotations');
const _post__quotations = require(base_path + '/handlers/POST/api/quotations/post__quotations');
...
const _patch__quotations__quotation_id__disable = require(base_path +
  '/handlers/PATCH/api/quotations/{quotation_id}/disable/patch__quotations__{quotation_id}__disable');
const _patch__quotations__quotation_id__enable = require(base_path +
  '/handlers/PATCH/api/quotations/{quotation_id}/enable/patch__quotations__{quotation_id}__enable');

const _get__quotations__configs = require(base_path + '/handlers/GET/api/quotations/configs/get__quotations__configs');
...
const _patch__quotations__configs__config_id__enable = require(base_path +
  '/handlers/PATCH/api/quotations/configs/{config_id}/enable/patch__quotations__configs__{config_id}__enable');
