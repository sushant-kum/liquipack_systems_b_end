...
let _get__login = require(base_path + '/handlers/GET/api/login/get__login.handler');
let _get__login__token = require(base_path + '/handlers/GET/api/login/token/get__login__token.handler');
let _put__login__refreshtoken = require(base_path + '/handlers/PUT/api/login/refreshtoken/put__login__refreshtoken.handler');
let _get__users = require(base_path + '/handlers/GET/api/users/get__users');
let _post__user = require(base_path + '/handlers/POST/api/users/post__users');
...
router.route('/api/users').post(AuthController.isJWTAuthenticated, _post__user.handler);
