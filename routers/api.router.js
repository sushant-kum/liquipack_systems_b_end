...
let _get__login__token = require(base_path +
...
let _get__profile = require(base_path +
  "/handlers/GET/api/profile/:user_id/get__profile__:user_id");
let _put__profile = require(base_path +
