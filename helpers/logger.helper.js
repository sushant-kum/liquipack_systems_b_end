      ...
      if (
        ...
        for (let j = 0; j < arguments.length - 1; j++) {
          if (typeof arguments[j] == "object") {
            if (argument instanceof Error) console.log(log(arguments[j].stack));
            else console.log(log(JSON.stringify(arguments[j], null, "\t")));
          } else {
      ...
      if (
        ...
        for (let j = 0; j < arguments.length - 1; j++) {
          if (typeof arguments[j] == "object") {
            ...
            else console.info(info(JSON.stringify(arguments[j], null, "\t")));
          } else {
      ...
      if (
        ...
        for (let j = 0; j < arguments.length - 1; j++) {
          if (typeof arguments[j] == "object") {
            ...
            else console.warn(warn(JSON.stringify(arguments[j], null, "\t")));
          } else {
      ...
      if (
        ...
        for (let j = 0; j < arguments.length - 1; j++) {
          if (typeof arguments[j] == "object") {
            ...
            else console.error(error(JSON.stringify(arguments[j], null, "\t")));
          } else {
